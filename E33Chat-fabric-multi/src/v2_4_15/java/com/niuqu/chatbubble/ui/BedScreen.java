    ...
    private void sendWakeUp() {
        if (client != null && client.player != null) {
            client.player.networkHandler.sendPacket(
                new net.minecraft.network.protocol.game.ServerboundPlayerCommandPacket(client.player, net.minecraft.network.protocol.game.ServerboundPlayerCommandPacket.Action.STOP_SLEEPING));
        }
    }
}
