...
public class ChatBubbleScreen extends ChatScreen {
    ...
    protected void init() {
        ...
        // Keep the raw emoji sequence for sending, but draw its bundled glyph
        // without U+FE0F. Vanilla's edit box otherwise shows FE0F as "VS16".
    ...
    private void sendMessage() {
        ...
        if (raw.contains("[[CICode,url=file://")) {
            ...
            //#else
            client.player.sendMessage(Text.translatable("e33chat.upload.disabled"), false);
            //#endif
            return;
        }
        sendMessageText(raw);
