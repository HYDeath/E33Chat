...
public class ChatSearchPanel {
    ...
    public void render(DrawContext g, int mouseX, int mouseY,
        ...
        com.niuqu.chatbubble.UiCompat.drawBorder(g, px, py, w, PANEL_H, ChatBubbleTheme.alphaBlend(c.divider(), a255));
        ...
        if (hoverInput || searchInput.isFocused())
            com.niuqu.chatbubble.UiCompat.drawBorder(g, inputX, inputY, inputW, INPUT_H, com.niuqu.chatbubble.render.ChatBubbleTheme.alphaBlend(c.textMuted(), a255));
