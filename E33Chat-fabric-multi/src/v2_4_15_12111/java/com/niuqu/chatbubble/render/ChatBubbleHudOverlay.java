...
public class ChatBubbleHudOverlay {
    ...
    private static void drawIcon(DrawContext g, int x, int y) {
        ...
        com.niuqu.chatbubble.RenderHelper.drawTexture(g, chatIconTex(), x, y, 0.0F, 0.0F, ICON_S, ICON_S, ICON_S, ICON_S);
    }

    private static void drawScaledTip(DrawContext g, int x, int y, int disp) {
        Identifier tex = ChatBubbleScreen.iconTex("private_tip");
        com.niuqu.chatbubble.RenderHelper.drawTexture(g, tex, x, y, disp, disp, (float) SRC_U, (float) SRC_V, SRC_S, SRC_S, 16, 16);
    }
}
