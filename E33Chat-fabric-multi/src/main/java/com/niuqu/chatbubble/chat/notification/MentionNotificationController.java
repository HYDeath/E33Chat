...
public class MentionNotificationController {
    ...
    public void onMessageCaptured(Text content, ChatMessageStore.SenderMeta meta,
        ...
        onMessageCaptured(content, meta, messageIndex, replySender, false);
    }

    public void onMessageCaptured(Text content, ChatMessageStore.SenderMeta meta,
                                  int messageIndex, String replySender, boolean serverResolvedMention) {
        ...
        if (!serverResolvedMention && !MentionDetector.isMentioned(text, localName, requireAt, replySender)) return;
