...
abstract class NMS {
    ...
    companion object {
        ...
        val instance by unsafeLazy {
            // 26.3 changes internal chat/network shapes. Public Paper Adventure
            // delivery remains available while TabooLib catches up with NMS.
            if (Bukkit.getBukkitVersion().startsWith("26.3")) return@unsafeLazy NMSImplFallback()
