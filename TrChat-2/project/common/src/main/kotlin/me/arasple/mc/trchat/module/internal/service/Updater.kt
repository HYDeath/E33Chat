...
object Updater {
    ...
    // TabooLib's Version parser accepts dotted numeric releases, but not the
    // SemVer build metadata used by this compatibility fork.
    val current_version = Version(pluginVersion.substringBefore('+'))
